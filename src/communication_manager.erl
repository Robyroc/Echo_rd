...
handle_call({send_msg, Method, Params, Address, Alias}, _From, State) ->
  case logging_policies:check_policy(?MODULE) of
    ...
    able ->
      ...
      allPolicies:info("### OUT ###: Method:~p | Params:~p | Address:~p \n", [Method, Params, Address]);
    unable -> ok
  end,
...
handle_cast({send_msg, Method, Params, Address, Alias}, State) ->
  case logging_policies:check_policy(?MODULE) of
    able ->
      ...
      allPolicies:info("### OUT ###: Method:~p | Params:~p | Address:~p~n", [Method, Params, Address]);
...
handle_cast({rcv_msg, Method, Address, Params}, State) ->
  ...
  case logging_policies:check_policy(?MODULE) of
    able ->
      allPolicies:info("### IN ###: Method:~p | Params:~p | Address:~p~n", [BackTranslated, DecodedParams, Address]),
